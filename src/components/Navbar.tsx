...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* DESKTOP */}
        <div className="hidden md:flex items-center h-[64px] max-w-7xl mx-auto px-6">
          <div className="flex-1 flex items-center gap-8">
            <a href="/collection" className={`relative flex flex-col items-center leading-none py-2 ${tx} hover:text-accent transition-colors duration-200 group`}>
              <span className="text-[9px] text-accent tracking-[0.4em] mb-1">探索</span>
            ...
            <a href="/our-story" className={`relative flex flex-col items-center leading-none py-2 ${tx} hover:text-accent transition-colors duration-200 group`}>
              <span className="text-[9px] text-accent tracking-[0.4em] mb-1">物語</span>
          ...
          <div className="flex-1 flex items-center justify-end gap-8">
            {isAdmin ? (
              <a href="/admin" className="relative flex flex-col items-center leading-none py-2 text-accent hover:text-accent/70 transition-colors duration-200 group">
                <span className="text-[9px] text-accent tracking-[0.4em] mb-1">管理</span>
              ...
              <a href="/collection" className={`relative flex flex-col items-center leading-none py-2 ${tx} hover:text-accent transition-colors duration-200 group`}>
                <span className="text-[9px] text-accent tracking-[0.4em] mb-1">商品</span>
                <span className="text-sm tracking-wide">Collection</span>
                <span className="absolute bottom-1 right-0 h-[1px] w-0 bg-accent transition-all duration-300 ease-out group-hover:w-full" />
              </a>
            )}
            <a href="/contact" className={`relative flex flex-col items-center leading-none py-2 ${tx} hover:text-accent transition-colors duration-200 group`}>
              <span className="text-[9px] text-accent tracking-[0.4em] mb-1">連絡</span>
